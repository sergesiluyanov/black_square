...
class _NewChatScreenState extends State<NewChatScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (myName.isNotEmpty) _myNameController.text = myName;
    });
  }
  ...
  Future<void> _createChat() async {
    ...
    if (myName.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Введите ваше имя — оно отображается в пушах при звонках и сообщениях'),
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: 'Ваше имя',
                helperText: 'Отображается в пушах при звонках и сообщениях',
                helperStyle: TextStyle(color: Colors.white.withValues(alpha: 0.5), fontSize: 12),
